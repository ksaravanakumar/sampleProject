...
public static final Logger log = LogManager.getLogger(ReadRequest.class.getName());
...
public ReadRequest(String[] args)
{
	 ReadRequest.args = args;		 
}
...
{// reading from the property file
	try 
	{
		...
		qName= mqProperties.getProperty("qName");
		resqname = mqProperties.getProperty("resqName");
...
Thread runner = new Thread(new ReadRequest(args)); 
runner.start();
