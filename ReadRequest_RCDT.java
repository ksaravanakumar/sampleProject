...
public class ReadRequest_RCDT implements Runnable
{
...
public static final Logger log = LogManager.getLogger(ReadRequest_RCDT.class.getName());
...
public ReadRequest_RCDT(String[] args)
{
	ReadRequest_RCDT.args = args;		 
}
...
{// connect, open, browse, close & disconnects
		...
		WriteResponse_RCDT wr = new WriteResponse_RCDT();
...
Thread runner = new Thread(new ReadRequest_RCDT(args)); 
runner.start();
