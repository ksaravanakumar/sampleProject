...
public class CreateCAPResponse extends WriteResponse {
	
	public void createCAPHeader()
	{
	...
	public void createCAPPositiveResp(String temps)

	{
		...
		amountCA.appendChild(doc.createTextNode("167892.83"));
		...
		amountCA2.appendChild(doc.createTextNode("167892.83"));
		...
		amountCA3.appendChild(doc.createTextNode("167892.83"));
		...
		effDT6.appendChild(doc.createTextNode("2015-10-12T00:05:27Z"));
		...
		effDT7.appendChild(doc.createTextNode("2015-10-12T00:05:27Z"));
		...
		effDT8.appendChild(doc.createTextNode("2015-10-12T00:05:27Z"));
		...
		amountCA10.appendChild(doc.createTextNode("167892.83"));
		...
		Element effDT12 = doc.createElement("EffDt");
		effDT12.appendChild(doc.createTextNode("2015-10-12T00:05:27Z"));
		acctbal12.appendChild(effDT12);
		...
		acctbal11.appendChild(curamt13);
		...
		amountCA18.appendChild(doc.createTextNode("80000.00"));
		curamt18.appendChild(amountCA18);
		
		Element acctshortname = doc.createElement("AcctShortName");
		acctshortname.appendChild(doc.createTextNode("COR RSL CLUB"));
	...
	public void createCAPNegativeResponse(String respStatus, String temps)
	{		
		 System.out.println(respStatus);	
         if (respStatus.equals("INVALID-ACCT"))
 	     {		
        	 createCAPInvAccResponse(temps);
  		  }
         else if (respStatus.equals("CLOSED-ACCT"))
 		  {		
        	 createCAPCloAccResponse(temps);
 		  }
         else if (respStatus.equals("UNAVAILABLE-ACCT"))
		  {		
        	 createCAPNotAvlResponse(temps);
		  }
          else 
		  {		
	...
	public void createCAPInvAccResponse(String temps)
	{
		Element acctrec = doc.createElement("AcctRec");
		acctbatchinqrs.appendChild(acctrec);
	...
	public void createCAPCloAccResponse(String temps)
	{
		Element acctrec = doc.createElement("AcctRec");
		acctbatchinqrs.appendChild(acctrec);
	...
	public void createCAPNotAvlResponse(String temps)
	{
